...
$field="max(a.add_time)add_time,a.user_id userid,b.phone,b.username";
$where="";
...
<div id="right" >
    <p class="where-is">您当前的位置：预定管理－＞查看预定会员列表</p>
                ...
                <td height="50" bgcolor="#666666">
                    <table width="670" height="25" border="0" align="center" cellpadding="0" cellspacing="1">
                        ...
                        <tr>
                            ...
                            <td width="200" bgcolor="#FFFFFF"><div align="center">最近预定时间</div></td>
                        ...
                        <?php foreach($data['data'] as $v){ ?>
                            <tr>
                                ...
                                <td height="25" bgcolor="#FFFFFF"><div align="center"><a href= "ck_user_appointment_detail.php?id=<?php echo $v['userid']?>" data-id="<?php echo $v['userid']?>">查看详情</a>
                                    </div></td>
                            </tr>
                        <?php }?>
                    </table></td>
